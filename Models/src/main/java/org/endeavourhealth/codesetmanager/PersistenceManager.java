package org.endeavourhealth.codesetmanager;
...
public class PersistenceManager {
    ...
    private static synchronized void createEntityManager() throws Exception {
        ...
        JsonNode json = ConfigManager.getConfigurationAsJson("database", "code-set-manager");
        ...
        entityManagerFactory = Persistence.createEntityManagerFactory("CodeSetManager", properties);
    }
}
